  ...
  return (
    <>
      ...
      <div className="relative">
        <div
          id="overPic"
          className="flex flex-col h-screen items-center sm:relative bg-mobilePortrait bg-wallSelfie sm:w-full w-screen"
        >
        ...
        >
          ...
          >
            ...
            <p className="max-w-[40rem]">
              ...
              passion learning science and technology that shapes the future. My
              intersts in technology include full stack web development,
